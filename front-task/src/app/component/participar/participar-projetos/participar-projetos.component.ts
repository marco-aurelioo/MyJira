...
import { PublicProjetosService } from 'src/app/service/public-projetos.service';
...
constructor(
  ...
  private publicProjetoService: PublicProjetosService,
...
//busca projetos no backend
  buscarProjetos(): void {
    ...
    this.publicProjetoService.findPublicProjetos(this.paginaAtual, this.tamanhoPagina, this.termoBusca).subscribe(
      (page)=> {
        console.log(page);
